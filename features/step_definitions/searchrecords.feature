Feature: search box 
    ...
    Scenario: when show the report , can search records 
   ...
   Scenario: when show the report ,can search records and select entries/page 25
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: when show the report ,can search records and select entries/page 50
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: when show the report ,can search records and select entries/page All
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
