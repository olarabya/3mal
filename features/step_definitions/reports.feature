Feature: Show reports 
    ...
    Scenario: admin can show the report without select profession from profession dropdown but fill other field
        ...
        And select report type from Report type dropdown
        ...
        Then should be show the Report 

    Scenario: admin show the report with empty project, empty report period ,empty profession from dropdown   
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin show the report with empty project ,empty report period ,and without select profession from dropdown
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin show the report with select report type,report period ,profession but project without type any thing    
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin show the report with select report type,project ,profession but report period without type anything    
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin show the report with select report type,project ,but report period without type anything and without select profession    
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin show the report with select report type,report period ,but project without type anything and without select profession    
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin show the report without select project ,and profession 
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin show the report without select report period ,and profession 
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin show the report without select project ,report period and profession 
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
    ...
    Scenario: admin can show the report when select report type , project, report period and profession dropdown
        Given a user http://amalui.eu-west-1.elasticbeanstalk.com/#/pages/login
        When user login using valid credentials 
        And logged in successfully and redirected to the home page 
        And click on Reports option 
